...
import LetrecoBoardReplay from './LetrecoBoardReplay'

export default function LetrecoHistoryList({ games, isSignedIn, onEdit, onChanged }) {
            ...
            <div className="history-item" key={game.id}>
              ...
              {expanded && (
                <div className="history-item-detail">
                  <LetrecoBoardReplay guesses={game.solution?.guesses} />
                  {game.solution?.word && (
                    <p className="text-meta history-answer">word: {game.solution.word}</p>
                  )}
