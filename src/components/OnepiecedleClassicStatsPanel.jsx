...
// an entry is either "solved" or still "in progress." Same "completed"/
// "solve %" wording precedent as LoLdle Classic and Strands.
export default function OnepiecedleClassicStatsPanel({ stats }) {
  const primary = [
