...
import { onepiecedlePuzzleDateFor } from '../lib/onepiecedlePuzzleDate'
import OnepiecedleBoardReplay from './OnepiecedleBoardReplay'

export default function OnepiecedleClassicHistoryList({ games, guessesByGame, isSignedIn, onEdit, onChanged }) {
            ...
            <div className="history-item" key={game.id}>
              <button type="button" className="history-item-row" onClick={() => toggleExpand(game.id)}>
                <div className="history-item-row-top">
                  ...
                  <span className="text-meta history-item-date">{onepiecedlePuzzleDateFor(game.puzzle_number)}</span>
                  <svg
              ...
              {expanded && (
                <div className="history-item-detail">
                  ...
                  <OnepiecedleBoardReplay guesses={guessesByGame[game.id] ?? []} />
                  {game.solution?.character && <p className="text-meta history-answer">character: {game.solution.character}</p>}
