...
export default function OnepiecedleDevilFruitHistoryList({ games, isSignedIn, onEdit, onChanged }) {
            ...
            <div className="history-item" key={game.id}>
              ...
              {expanded && (
                <div className="history-item-detail">
                  ...
                  {game.devil_fruit && (
                    <p className="text-meta history-answer">devil fruit: {game.devil_fruit}</p>
                  )}
                  {game.solution?.character && (
                    <p className="text-meta history-answer">character: {game.solution.character}</p>
                  )}
