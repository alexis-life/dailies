...
// Devil Fruit mode has no win/lose, so `won` is always true on its entries —
// that makes computeStats' streak math (won + consecutive puzzle numbers)
// resolve to a "played every day" streak for free, same trick used for
// LoLdle Emoji and Aniguessr.
export default function OnepiecedleDevilFruitStatsPanel({ games }) {
