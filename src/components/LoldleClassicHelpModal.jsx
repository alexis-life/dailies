      ...
      <div className="ax-card modal-panel help-modal">
        ...
        <section className="help-section">
          ...
          <p className="ax-meta help-example-caption">
            ...
            species partially overlap (orange, since both are Middle champions and both Human),
            resource matches exactly (green), range type and region don't overlap at all (red), and
            Annie released before Irelia (red, down arrow).
          </p>
        </section>
