...
import OnepiecedleDevilFruitStatsPanel from '../../components/OnepiecedleDevilFruitStatsPanel'
import OnepiecedleDevilFruitLogForm from '../../components/OnepiecedleDevilFruitLogForm'
import OnepiecedleDevilFruitHistoryList from '../../components/OnepiecedleDevilFruitHistoryList'
import ResetCountdown from '../../components/ResetCountdown'

export default function OnepiecedleDevilFruitGame({ isSignedIn }) {
  ...
  const loadData = useCallback(async () => {
    ...
    const gamesRes = await supabase
      ...
      .select('*')
      .eq('game', 'onepiecedle_devilfruit')
      ...
      {loading ? (
        ...
        <div className="page-grid">
          <div className="page-col page-col--main">
            <OnepiecedleDevilFruitStatsPanel games={games} />
            <OnepiecedleDevilFruitHistoryList
              games={games}
